...
class MSRVTT_DataLoader(Dataset):
    ...
    def _get_text(self, video_id, sentence):
        ...
        encodedSentence = self.sentenceEncoder(sentence)
        print(f'EcodedSentence shape: {encodedSentence.shape}, pair_text shape: {pairs_text.shape}')
        input('waiting....')
...
class MSRVTT_TrainDataLoader(Dataset):
    ...
    def _get_text(self, video_id, caption=None):
        ...
        encodedSentence = self.sentenceEncoder(caption)
        # print(f'EcodedSentence shape: {encodedSentence.shape}, pair_text shape: {pairs_text[0].shape} \n{caption}')
        # input('waiting....')
    ...
    def __getitem__(self, idx):
        ...
        encodedSentence, pairs_text, pairs_mask, pairs_segment, choice_video_ids = self._get_text(video_id, caption)
        video, video_mask = self._get_rawvideo(choice_video_ids)
